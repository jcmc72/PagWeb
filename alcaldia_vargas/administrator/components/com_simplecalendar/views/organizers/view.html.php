 ...
 * @since       1.6
 */
class SimpleCalendarViewOrganizers extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		SimpleCalendarHelper::addSubmenu('organizers');
	...
	protected function addToolbar()
	{
		...
		$canDo = SimpleCalendarHelper::getActions($this->state->get('filter.category_id'));
		$user = JFactory::getUser();
		// Get the toolbar object instance
		$bar = JToolBar::getInstance('toolbar');

		JToolbarHelper::title(JText::_('COM_SIMPLECALENDAR_MANAGER_ORGANIZERS'), 'sc.png');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			if ($this->state->get('filter.state') != -1)
			{
				...
				{
					JToolbarHelper::unarchiveList('organizers.publish');
				}
			}
		}
		...
		JToolbarHelper::help('JHELP_COMPONENTS_SIMPLECALENDAR_ORGANIZERS');

		JHtmlSidebar::setAction('index.php?option=com_simplecalendar&view=organizers');
...
// 		);
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_SIMPLECALENDAR_ORGANIZER_HEADING_NAME'),
			'a.abbr' => JText::_('COM_SIMPLECALENDAR_ORGANIZER_HEADING_ABBR'),
