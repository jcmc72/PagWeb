...
/**
 * View to edit an event status.
 *
 * @subpackage  com_simplecalendar
 */
class SimpleCalendarViewStatus extends JViewLegacy
{
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_SIMPLECALENDAR_STATUS_NEW_STATUS') : JText::_('COM_SIMPLECALENDAR_STATUS_EDIT_STATUS'), 'sc.png');
		...
		JToolbarHelper::help('JHELP_COMPONENTS_SIMPLECALENDAR_EDIT_STATUS');
	}
