		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible">
					<?php echo JText::_('COM_SIMPLECALENDAR_FILTER_SEARCH_IN_TITLE');?>
				</label>
				<input type="text" name="filter_search" id="filter_search" 
					placeholder="<?php echo JText::_('COM_SIMPLECALENDAR_FILTER_SEARCH_IN_TITLE'); ?>" 
					value="<?php echo $this->escape($this->state->get('filter.search')); ?>" 
					title="<?php echo JText::_('COM_SIMPLECALENDAR_FILTER_SEARCH_IN_TITLE'); ?>"
				/>
			</div>
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th width="30%">
						<?php echo JHtml::_('grid.sort', 'COM_SIMPLECALENDAR_HEADING_EVENT_NAME', 'a.name', $listDirn, $listOrder); ?>
					</th>
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_SIMPLECALENDAR_HEADING_DATE', 'a.start_dt', $listDirn, $listOrder); ?>
					</th>
					<th class="nowrap">
						<?php echo JHtml::_('grid.sort', 'COM_SIMPLECALENDAR_HEADING_EVENT_VENUE', 'a.venue', $listDirn, $listOrder); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'COM_SIMPLECALENDAR_HEADING_CATEGORY', 'category_title', $listDirn, $listOrder); ?>
					</th>
