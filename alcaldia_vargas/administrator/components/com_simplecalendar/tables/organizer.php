 ...
 * @since       1.5
 */
class SimplecalendarTableOrganizer extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__simplecalendar_organizers', 'id', $_db);
	...
	public function store($updateNulls = true)
	{
		...
		else
		{
			...
			// Get the old row
			$oldrow = JTable::getInstance('Organizer', 'SimplecalendarTable');
			...
			$table = JTable::getInstance('Organizer', 'SimplecalendarTable');
